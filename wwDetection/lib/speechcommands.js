    ...
    ***************************************************************************** */
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            period = Math.max(1, Math.round(this.numFrames * (1 - this.overlapFactor))); //43
        ...
        BrowserFftFeatureExtractor.prototype.onAudioFrame = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.analyser.getFloatFrequencyData(this.freqData); // 1024
                            if (this.freqData[0] === -Infinity) {
                                return [2];
                            }
                            this.freqDataQueue.push(this.freqData.slice(0, this.columnTruncateLength)); // 232 
                            if (this.includeRawAudio) {
    ...
    var BrowserFftSpeechCommandRecognizer = (function () {
        function BrowserFftSpeechCommandRecognizer(vocabulary, modelArtifactsOrURL, metadataOrURL) {
            ...
            this.MODEL_URL_PREFIX = "https://awahlang.github.io/wwDetection/models"
